...
import '../App.scss';
import { fetchOOF, handleInput, handleSelect, handleToggle, handleRadio, handleDarkMode, handlemoreCriteriasOpen } from '../store/actions/Actions';
    ...
    return (
      ...
      <h1><span>F</span><span>o</span><span>o</span><span>d</span><span>l</span><span>e</span></h1>
        <form>
          ...
          <input incremental={true} results={5} type='search' id='mainSearch' onChange={(e) => this.props.handleInput(e, 'search')} value={this.props.mainState.search} placeholder='Search...' />
          </div>
          ...
          {this.props.mainState.ismoreCriteriasOpen ? 
           <div className='advanced'>
            <MoreCriterias darkClass={darkClass} search={this.props.mainState} handleSelect={this.props.handleSelect} handleInput={this.props.handleInput} handleToggle={this.props.handleToggle} handleRadio={this.props.handleRadio}/>
            <ResButton
            fetchOOF={this.props.fetchOOF}
            search={this.props.mainState.search}
            products={this.props.mainState.products}
