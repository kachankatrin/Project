  ...
  return (
    <div className='more-criterias'>
      <div className="criterias-nutriments">
        <div>
          <h2>Criterion</h2>
          <div className={'input-bg select-margin ' + darkClass}>
            <Select 
              value={tagtype} 
              options={criterion} 
              handleChange={(e) => props.handleSelect(e, 'tagtype')} 
            />
          </div>
          <Toggle 
            label={RemoveUnderscore(tagContains)} 
            handleChange={(e) => props.handleToggle(e, 'tagContains')} 
          />
          <div className={'input-bg ' + darkClass}>
            <input 
              type='search' 
              id="CriteriaSearch1" 
              onChange={(e) => props.handleInput(e, 'tag')} 
              value={tag} 
              placeholder='value' 
            />
          </div>
          ...
          <Toggle 
            label={RemoveUnderscore(tagContains1)} 
            handleChange={(e) => props.handleToggle(e, 'tagContains1')} 
          />
          <div className={'input-bg ' + darkClass}>
            <input 
              type='search' 
              onChange={(e) => props.handleInput(e, 'tag1')} 
              value={tag1} 
              placeholder='value' 
            />
          </div>
        ...
        <div className='nutriments'>
          ...
          <div className={'input-bg select-margin ' + darkClass}>
            <Select 
              value={nutriment} 
              options={nutriments} 
              handleChange={(e) => props.handleSelect(e, 'nutriment', 'energyUnit')} 
            />
          </div>
          <div className='flex'>
            <div className={'input-bg ' + darkClass}>
              <Select 
                value={comparement} 
                options={comparements} 
                handleChange={(e) => props.handleSelect(e, 'comparement')} 
              />
            </div>
            <div className={'input-bg ' + darkClass}>
              <input 
                type='search' 
                placeholder='qty' 
                onChange={(e) => props.handleInput(e, 'nutrimentValue')} 
          ...
          <div className={'input-bg select-margin ' + darkClass}>
            <Select 
              value={nutriment1} 
              options={nutriments} 
              handleChange={(e) => props.handleSelect(e, 'nutriment1', 'energyUnit1')} 
            />
          </div>
          <div className='flex start'>
            <div className={'input-bg ' + darkClass}>
              <Select 
                value={comparement1} 
                options={comparements} 
                handleChange={(e) => props.handleSelect(e, 'comparement1')} 
              />
            </div>
            <div className={'input-bg ' + darkClass}>
              <input 
                type='search' 
                placeholder='qty' 
                onChange={(e) => props.handleInput(e, 'nutrimentValue1')} 
                value={nutrimentValue1} 
              />
            </div>
          </div>
        </div>
      ...
      <div className='Ingredients'>
        ...
        <RadioButtons 
          ...
          values={[
            { value: 'with', label: 'With', checked: ingPalmOil === 'with' },
        ...
        <RadioButtons 
          ...
          values={[
            { value: 'with', label: 'With', checked: ingMayBePalmOil === 'with' },
        ...
        <RadioButtons 
          ...
          values={[
            { value: 'with', label: 'With', checked: ingPalmOilORMayBePalmOil === 'with' },
