    ...
    <div className='more-criterias'>
      <div className="criterias-nutriments">
        <div>
          ...
          <div className={'input-bg ' + darkClass}>
            <input type='search' onChange={(e) => props.handleInput(e, 'tag1')} value={tag1} placeholder='value' />
          </div>
        </div>
      ...
      <div className='Ingredients'>
        ...
        />
        <RadioButtons darkClass={darkClass} name='Ingredients from palm oil' values={[
        ...
        />
        <RadioButtons darkClass={darkClass} name='Ingredients that may be from palm oil' values={[
        ...
        <RadioButtons darkClass={darkClass} name='Ingredients from or that may be from palm oil' values={[
